...
/** @constructor */
function $c_Lmrabezreb_scalajsthingy_Bootstrap$() {
  $c_O.call(this)
}
$c_Lmrabezreb_scalajsthingy_Bootstrap$.prototype = new $h_O();
$c_Lmrabezreb_scalajsthingy_Bootstrap$.prototype.constructor = $c_Lmrabezreb_scalajsthingy_Bootstrap$;
/** @constructor */
function $h_Lmrabezreb_scalajsthingy_Bootstrap$() {
  /*<skip>*/
}
$h_Lmrabezreb_scalajsthingy_Bootstrap$.prototype = $c_Lmrabezreb_scalajsthingy_Bootstrap$.prototype;
$c_Lmrabezreb_scalajsthingy_Bootstrap$.prototype.init___ = (function() {
  return this
});
$c_Lmrabezreb_scalajsthingy_Bootstrap$.prototype.apply__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("head").append("<link href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\" rel=\"stylesheet\" integrity=\"sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u\" crossorigin=\"anonymous\">");
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("head").append("<script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js\" integrity=\"sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa\" crossorigin=\"anonymous\"></script>")
});
var $d_Lmrabezreb_scalajsthingy_Bootstrap$ = new $TypeData().initClass({
  Lmrabezreb_scalajsthingy_Bootstrap$: 0
}, false, "mrabezreb.scalajsthingy.Bootstrap$", {
  Lmrabezreb_scalajsthingy_Bootstrap$: 1,
  O: 1
});
$c_Lmrabezreb_scalajsthingy_Bootstrap$.prototype.$classData = $d_Lmrabezreb_scalajsthingy_Bootstrap$;
var $n_Lmrabezreb_scalajsthingy_Bootstrap$ = (void 0);
function $m_Lmrabezreb_scalajsthingy_Bootstrap$() {
  if ((!$n_Lmrabezreb_scalajsthingy_Bootstrap$)) {
    $n_Lmrabezreb_scalajsthingy_Bootstrap$ = new $c_Lmrabezreb_scalajsthingy_Bootstrap$().init___()
  };
  return $n_Lmrabezreb_scalajsthingy_Bootstrap$
}
/** @constructor */
...
/** @constructor */
function $c_Lmrabezreb_scalajsthingy_Main$() {
  $c_O.call(this);
  this.times$1 = 0
}
$c_Lmrabezreb_scalajsthingy_Main$.prototype = new $h_O();
$c_Lmrabezreb_scalajsthingy_Main$.prototype.constructor = $c_Lmrabezreb_scalajsthingy_Main$;
/** @constructor */
function $h_Lmrabezreb_scalajsthingy_Main$() {
  /*<skip>*/
}
$h_Lmrabezreb_scalajsthingy_Main$.prototype = $c_Lmrabezreb_scalajsthingy_Main$.prototype;
$c_Lmrabezreb_scalajsthingy_Main$.prototype.init___ = (function() {
  this.times$1 = 0;
  return this
});
$c_Lmrabezreb_scalajsthingy_Main$.prototype.main__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)((function() {
    $m_Lmrabezreb_scalajsthingy_Main$().setupUI__V()
  }))
});
$c_Lmrabezreb_scalajsthingy_Main$.prototype.setupUI__V = (function() {
  $m_Lmrabezreb_scalajsthingy_Bootstrap$().apply__V();
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("head").append("<style>.btn-circle {text-align: center; border-radius: 50%; padding: 0;}</style>");
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append($as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Hello, World!"))])).render__Lorg_scalajs_dom_raw_Element());
  var jsx$6 = (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body");
  var jsx$5 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().a__Lscalatags_generic_TypedTag());
  var jsx$4 = $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("hei", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$3 = $m_Lscalatags_JsDom$all$().style__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("width: 100px; height: 100px; line-height: 100px; background: red; font-size: 50px;", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$2 = $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr();
  var jsx$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    $m_Lmrabezreb_scalajsthingy_Main$().addClickedMessage__V()
  }));
  ...
  jsx$6.append(jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$4, jsx$3, jsx$2.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$1, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$3, ev)), $m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn btn-default btn-circle", $m_Lscalatags_JsDom$all$().stringAttr$1)])).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().span__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("glyphicon glyphicon-warning-sign", $m_Lscalatags_JsDom$all$().stringAttr$1)]))])).render__Lorg_scalajs_dom_raw_Element())
});
$c_Lmrabezreb_scalajsthingy_Main$.prototype.addClickedMessage__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>you click big red button you go boom</p>")
});
$c_Lmrabezreb_scalajsthingy_Main$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lmrabezreb_scalajsthingy_Main$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lmrabezreb_scalajsthingy_Main$ = new $TypeData().initClass({
  Lmrabezreb_scalajsthingy_Main$: 0
}, false, "mrabezreb.scalajsthingy.Main$", {
  Lmrabezreb_scalajsthingy_Main$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lmrabezreb_scalajsthingy_Main$.prototype.$classData = $d_Lmrabezreb_scalajsthingy_Main$;
var $n_Lmrabezreb_scalajsthingy_Main$ = (void 0);
function $m_Lmrabezreb_scalajsthingy_Main$() {
  if ((!$n_Lmrabezreb_scalajsthingy_Main$)) {
    $n_Lmrabezreb_scalajsthingy_Main$ = new $c_Lmrabezreb_scalajsthingy_Main$().init___()
  };
  return $n_Lmrabezreb_scalajsthingy_Main$
}
$e.mrabezreb = ($e.mrabezreb || {});
$e.mrabezreb.scalajsthingy = ($e.mrabezreb.scalajsthingy || {});
...
/** @constructor */
function $h_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$() {
  /*<skip>*/
}
...
}, false, "mrabezreb.scalajsthingy.dungeonsandlizards.GamePage$", {
  Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$.prototype.$classData = $d_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$;
var $n_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$ = (void 0);
function $m_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$() {
  if ((!$n_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$)) {
    $n_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$ = new $c_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$().init___()
  };
  return $n_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$
}
$e.mrabezreb = ($e.mrabezreb || {});
$e.mrabezreb.scalajsthingy = ($e.mrabezreb.scalajsthingy || {});
$e.mrabezreb.scalajsthingy.dungeonsandlizards = ($e.mrabezreb.scalajsthingy.dungeonsandlizards || {});
$e.mrabezreb.scalajsthingy.dungeonsandlizards.GamePage = $m_Lmrabezreb_scalajsthingy_dungeonsandlizards_GamePage$;
/** @constructor */
...
$c_Lscalatags_JsDom$all$.prototype.style$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  ...
  var hi = (4 & b.hi$2);
  if ((hi === 0)) {
    this.style$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this, "style", null, false);
    var b$1 = this.bitmap$4$1;
    var lo = b$1.lo$2;
    var hi$1 = (4 | b$1.hi$2);
...
//# sourceMappingURL=scala-js-site-fastopt.js.map
